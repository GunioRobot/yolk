...
\date{Revised september 1st. 2011}
...
\subsection{Initializing the compressed cache directory}
...
that the directory exists and is empty, you should call the \emph{Initialize\_Compressed\_Cache\_Directory}
procedure:
...
Calling \emph{Initialize\_Compressed\_Cache\_Directory} is of course
only necessary if you plan on using the \emph{Yolk.Static\_Content.Compressable}
function.
